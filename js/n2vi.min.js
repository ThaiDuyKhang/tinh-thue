...
var string="";
  while(index >= 0){
     arr.push(str.substring(index,Math.max(index-3,0)));index-=3
}
  for(i=arr.length-1;i>=0;i--){
     if(arr[i]!=""&&arr[i]!="000")string+=" "+block_of_three(arr[i])+" "+u[i]}return string.replace(/[0-9]/g,"").replace(/  /g," ")+" "+currency
}
})
(window);
